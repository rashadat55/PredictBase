...
// --- YAPILANDIRMA ---
const RECEIVER_ADDRESS = "0x6B5C4E1E11217318e039eE40B26174316f896a7D"; // Ödemelerin gideceği adres
...
const MATCHES = [
    ...
    { id: 78, date: 'Wed 01 July 2026', time: '01:00', stage: 'Round of 32', stadium: 'New York/NJ', home: { n: '1I', c: '1I', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    { id: 79, date: 'Wed 01 July 2026', time: '05:00', stage: 'Round of 32', stadium: 'Mexico City', home: { n: '1A', c: '1A', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    { id: 80, date: 'Wed 01 July 2026', time: '20:00', stage: 'Round of 32', stadium: 'Atlanta', home: { n: '1L', c: '1L', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    { id: 81, date: 'Thu 02 July 2026', time: '00:00', stage: 'Round of 32', stadium: 'Seattle', home: { n: '1G', c: '1G', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    { id: 82, date: 'Thu 02 July 2026', time: '04:00', stage: 'Round of 32', stadium: 'San Francisco', home: { n: '1D', c: '1D', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    ...
    { id: 85, date: 'Fri 03 July 2026', time: '07:00', stage: 'Round of 32', stadium: 'Vancouver', home: { n: '1B', c: '1B', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
    ...
    { id: 88, date: 'Sat 04 July 2026', time: '05:30', stage: 'Round of 32', stadium: 'Kansas City', home: { n: '1K', c: '1K', f: '🏳️' }, away: { n: '3RD', f: '🏳️' } },
...
async function setupWallet() {
    ...
    try {
        if (ENV === 'farcaster') {
            ...
            if (!window.ethereum) {
                alert("Please use a Web3 browser (Coinbase, MetaMask, etc.)");
...
async function handleTransaction() {
    ...
    const statusMsg = document.getElementById('tx-status');
    ...
    try {
        ...
        alert("Predict confirmed! Tx: " + txHash);
    ...
    list.innerHTML = filtered.map(m => `
        <div class="bg-white/5 p-4 rounded-xl border border-white/10 flex justify-between items-center relative mb-4 transition-all hover:border-emerald-500/50">
            <div class="flex flex-col items-center w-1/3">
                ...
                <div class="text-[10px] font-black uppercase text-center text-white leading-tight">${m.home.n}</div>
            </div>
            <div class="flex flex-col items-center justify-center">
                <div class="text-[7px] text-emerald-400 font-bold uppercase tracking-tighter">${m.stage}</div>
                <div class="text-lg font-black text-white/40">VS</div>
                <div class="text-[7px] text-gray-500 font-bold uppercase">${m.date}</div>
            </div>
            <div class="flex flex-col items-center w-1/3">
                <div class="text-3xl mb-1">${m.away.f}</div>
                <div class="text-[10px] font-black uppercase text-center text-white leading-tight">${m.away.n}</div>
            </div>
            <button onclick="window.openModal(${m.id})" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">Select</button>
        </div>
    `).join('');
}
